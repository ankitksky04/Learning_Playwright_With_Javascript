...
```js
const obj1 = { a: 1, b: 2 };
obj1.a = 99;          // OK â€” mutate existing property
obj1.c = 3;           // OK â€” add property
delete obj1.b;        // OK â€” remove property
...
```js
const obj1 = { a: 1, b: 2 };
obj1 = { x: 5 };      // âŒ TypeError: Assignment to constant variable.
```
...
**Need a changed copy? Spread into a new `const` â€” don't reassign:**
...
**When `let`/`var` *is* justified â€” the binding itself is reassigned:**

```js
let current = { id: 1 };
current = { id: 2 };   // points to a different object â€” let needed
```
